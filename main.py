...
def augment_with_metadata_and_topic(dataset, extractor, candidate_labels, file_path, debug=False):
    ...
    :param file_path: The path to save/load the augmented dataset.
...
if __name__ == "__main__":
    ...
    train_file_path = f"augmented_train_{args.dataset_type}_{args.percentage}.csv"
    test_file_path = f"augmented_test_{args.dataset_type}_{args.percentage}.csv"
    val_file_path = f"augmented_val_{args.dataset_type}_{args.percentage}.csv"
